---
name: std-registers-design
description: >-
  Register design (info/accumulation/accounting/calc). Use when adding or redesigning registers.
disable-model-invocation: true
---

# std-registers-design — проектирование регистров
