---
name: std-platform-solutions
description: >-
  Known 1C platform pitfalls and proven patterns (long ops, temp storage, deadlocks, dates). Use when debugging platform quirks.
disable-model-invocation: true
---

# std-platform-solutions — ловушки платформы
