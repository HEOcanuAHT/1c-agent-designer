...
# Dot-source from Invoke-1cIbcmdDump.ps1 and Common-ServiceIb.ps1.
...
function Get-IbcmdCredHelperPath {
  return (Join-Path $script:CommonIbcmdConnectionHome "..\..\1c-project-bootstrap\scripts\1c-WindowsCredential.ps1")
}

function Get-IbAuthArgs($Cfg, [string]$ProjectRoot = "") {
  $credHelper = Get-IbcmdCredHelperPath
