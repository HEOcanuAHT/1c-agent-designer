---
name: std-anti-patterns
description: >-
  1C anti-pattern catalog with severity and fix templates. Use when reviewing or writing BSL for performance/correctness smells.
disable-model-invocation: true
---

# std-anti-patterns — антипаттерны и ревью
