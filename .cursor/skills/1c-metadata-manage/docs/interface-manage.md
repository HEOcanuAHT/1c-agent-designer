...
```powershell
powershell.exe -NoProfile -File .cursor/skills/1c-metadata-manage/tools/1c-interface-manage/scripts/interface-edit.ps1 -CIPath '<path>' -Operation <op> -Value '<value>'
```
...
```powershell
powershell.exe -NoProfile -File .cursor/skills/1c-metadata-manage/tools/1c-interface-manage/scripts/interface-validate.ps1 -CIPath '<path>'
```
