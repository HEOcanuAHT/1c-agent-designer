...
```powershell
powershell.exe -NoProfile -File .cursor/skills/1c-metadata-manage/tools/1c-mxl-compile/scripts/mxl-compile.ps1 -JsonPath "<path>.json" -OutputPath "<path>/Template.xml"
```
...
```powershell
powershell.exe -NoProfile -File .cursor/skills/1c-metadata-manage/tools/1c-mxl-decompile/scripts/mxl-decompile.ps1 -TemplatePath "<path>/Template.xml" [-OutputPath "<path>.json"]
```
...
```powershell
powershell.exe -NoProfile -File .cursor/skills/1c-metadata-manage/tools/1c-mxl-info/scripts/mxl-info.ps1 -TemplatePath "<path>"
```

Or by processor/template name:
```powershell
powershell.exe -NoProfile -File .cursor/skills/1c-metadata-manage/tools/1c-mxl-info/scripts/mxl-info.ps1 -ProcessorName "<Name>" -TemplateName "<Template>" [-SrcDir "<dir>"]
```
...
```powershell
powershell.exe -NoProfile -File .cursor/skills/1c-metadata-manage/tools/1c-mxl-validate/scripts/mxl-validate.ps1 -TemplatePath "<path>"
```

Or by processor/template name:
```powershell
powershell.exe -NoProfile -File .cursor/skills/1c-metadata-manage/tools/1c-mxl-validate/scripts/mxl-validate.ps1 -ProcessorName "<Name>" -TemplateName "<Template>" [-SrcDir "<dir>"]
```
...
When creating or modifying MXL spreadsheet layouts as part of a feature, update SDD artifacts if present (see `related std-* / 1c-forms skills` for detection):
