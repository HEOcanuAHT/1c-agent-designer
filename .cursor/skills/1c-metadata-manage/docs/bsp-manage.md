...
- Build EPF: skill `1c-external-epf` (не upstream epf-build)
...
When registering processors with BSP as part of a feature, update SDD artifacts if present (see `related std-* / 1c-forms skills` for detection):
