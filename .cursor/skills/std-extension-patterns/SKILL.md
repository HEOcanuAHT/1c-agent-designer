---
name: std-extension-patterns
description: >-
  CFE interceptors (&Перед/&После/&ИзменениеИКонтроль), ПродолжитьВызов, adopted objects. Use when writing or reviewing extension BSL.
disable-model-invocation: true
---

# std-extension-patterns — паттерны расширений (CFE)
...
- You **can** add your own attributes / tabular sections (with `{PREFIX}` from ``.1c/project.json``).
